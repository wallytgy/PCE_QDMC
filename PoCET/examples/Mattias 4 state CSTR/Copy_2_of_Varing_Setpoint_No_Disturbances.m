...
y_min = -0.05 *ones(15,1);   % Minimum output
y_max = 0.05*ones(15,1);    % Maximum output
...
c_D_desired = [0.075* ones(1,t_simulation/dt) ; zeros(14,t_simulation/dt)];
...
ylabel('c_{C,0,0} (L/s)')
subplot(5,1,2)
plot(t,X_response(:,47))
xlabel('Time (s)')
ylabel('c_{C,1,0} (L/s)')
subplot(5,1,3)
plot(t,X_response(:,48))
xlabel('Time (s)')
ylabel('c_{C,0,1} (L/s)')
subplot(5,1,4)
plot(t,X_response(:,49))
xlabel('Time (s)')
ylabel('c_{C,2,0} (L/s)')
subplot(5,1,5)
plot(t,X_response(:,50))
xlabel('Time (s)')
ylabel('c_{C,1,1} (L/s)')
plot(t,X_response(:,51))
xlabel('Time (s)')
ylabel('c_{C,0,2} (L/s)')