function dXdt = my_ODE(t,X,PoCETsys,u_t,u_v)
 ...
 ddt_c_B = - M.k_1_O2*c_Ac_B - M.k_2_O2*c_Ac_B -0.3264*M.one_O2*c_Bc_C -0.01591*M.one_O2*c_Bc_D -0.2*u*M.one_O1*c_B -0.75*M.one_O1*c_B + 1.47*M.one_O0;
 ddt_c_C = M.k_1_O2*c_Ac_B -0.3264*M.one_O2*c_Bc_C -0.2*u*M.one_O1*c_C -0.75*M.one_O1*c_C;
