...
for ii = 1:length(tsp_sim)-1
    ...
    d = [];
    F = reshape(Controller.F, n_out, n_sr+1);
    F(2:end,:) = 0;
    Controller.F = F(:);
...
print(gcf, '-depsc', 'varying_sp_nd_case_1_output_f0.eps');
...
xregion(50,150,'DisplayName',"First Output Fault","FaceColor",'w')
xregion(250,350,'DisplayName',"Second Output Fault","FaceColor",'w')
print(gcf, '-depsc', 'varying_sp_nd_case_1_control_f0.eps');
...
print(gcf, '-depsc', 'varying_sp_id_case_1_output_f0.eps');
...
xregion(50,150,'DisplayName',"First Input Fault","FaceColor",'r')
xregion(250,350,'DisplayName',"Second Input Fault","FaceColor",'r')
print(gcf, '-depsc', 'varying_sp_id_case_1_control_f0.eps');
...
print(gcf, '-depsc', 'varying_sp_od_case_1_output_f0.eps');
...
xregion(50,150,'DisplayName',"First Input Fault","FaceColor",'r')
xregion(250,350,'DisplayName',"Second Input Fault","FaceColor",'r')
print(gcf, '-depsc', 'varying_sp_od_case_1_control_f0.eps');
