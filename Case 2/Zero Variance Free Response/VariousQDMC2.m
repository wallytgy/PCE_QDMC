...
%%
plot_trajectories(y_store_all, ysp,"varying_sp_nd_case_2_output_f0.eps","r" ,false)
y_store_all_nd = y_store_all
%%
% 2) Shaded min–max envelopes plus mean trajectories
plotClusterTrajectories(u_store_all, flat_reps, representatives, tsp_sim, "varying_sp_nd_case_2_control_f0.eps",...
...
%%
plot_trajectories(y_store_all, ysp,"varying_sp_id_case_2_output_f0.eps","g" , true)
y_store_all_id = y_store_all
%%
% 2) Shaded min–max envelopes plus mean trajectories
plotClusterTrajectories(u_store_all, flat_reps, representatives, tsp_sim, "varying_sp_id_case_2_control_f0.eps",...
                        'PlotStyle','lines','Opacity',0.1,'ShowMean',true);
...
%%
plot_trajectories(y_store_all, ysp ,"varying_sp_od_case_2_output_f0.eps", "magenta" , true)
y_store_all_od = y_store_all
%%
% 2) Shaded min–max envelopes plus mean trajectories
plotClusterTrajectories(u_store_all, flat_reps, representatives, tsp_sim,"varying_sp_od_case_2_control_f0.eps",...
                        'PlotStyle','lines','Opacity',0.1,'ShowMean',true);
