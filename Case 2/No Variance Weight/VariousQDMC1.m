...
%%
plot_trajectories(y_store_all, ysp,"varying_sp_nd_case_2_output_zerovar.eps","r",false)
...
%%
plot_trajectories(y_store_all, ysp,"varying_sp_id_case_2_output_zerovar.eps","g"  ,true)
...
%%
plot_trajectories(y_store_all, ysp ,"varying_sp_od_case_2_output_zerovar.eps", "magenta", true)
