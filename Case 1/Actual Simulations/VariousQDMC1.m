...
print(gcf, '-depsc', 'varying_sp_nd_case_1_output.eps');
...
print(gcf, '-depsc', 'varying_sp_nd_case_1_control.eps');
xregion(50,150,'DisplayName',"First Output Fault","FaceColor",'w')
xregion(250,350,'DisplayName',"Second Output Fault","FaceColor",'w')
...
print(gcf, '-depsc', 'varying_sp_id_case_1_output.eps');
...
xregion(50,150,'DisplayName',"First Input Fault","FaceColor",'r')
xregion(250,350,'DisplayName',"Second Input Fault","FaceColor",'r')
print(gcf, '-depsc', 'varying_sp_id_case_1_control.eps');
...
print(gcf, '-depsc', 'varying_sp_od_case_1_output.eps');
...
xregion(50,150,'DisplayName',"First Input Fault","FaceColor",'r')
xregion(250,350,'DisplayName',"Second Input Fault","FaceColor",'r')
print(gcf, '-depsc', 'varying_sp_od_case_1_control.eps');
